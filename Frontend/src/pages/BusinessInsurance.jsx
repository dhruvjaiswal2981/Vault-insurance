 ...
 const handleSearchChange = (event) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Business quote submitted successfully!');
  ...
  return (
    <>
          ...
          <header className="w-full sticky z-50 bg-gradient-to-b from-[#6290FF] to-[#9D6FFF]">
              ...
              {/* Mobile Navigation */}
              {menuOpen && (
                <div className="lg:hidden bg-[#957CEB] bg-opacity-90 shadow-lg rounded-lg mt-2 mx-4">
                    ...
                    className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-6 md:gap-y-5 max-w-full md:max-w-[550px]">
                      ...
                      <div className="relative w-full h-[60px] shadow-[10px_10px_40px_0px_rgba(26,129,255,0.10)]">
                        <select
                          ...
                          className="appearance-none w-full h-full p-4 rounded-lg  focus:outline-none focus:ring-2 focus:ring-purple-400 text-base text-gray-400 placeholder-gray-400 pr-10 cursor-pointer"
                        >
