  ...
  return (
    <section id="about-vault" className="py-1 bg-white">
      <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row gap-6 md:gap-8 lg:gap-5 items-center justify-center text-center lg:text-left">
          ...
          <div className="w-full lg:w-[686px] h-auto lg:h-[750px] bg-[#F4F8FB] rounded-2xl md:rounded-[30px] p-6 sm:p-8 md:p-12 shadow-sm flex flex-col justify-center items-center lg:items-start">
